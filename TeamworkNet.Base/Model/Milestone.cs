// ==========================================================
// File: TeamWorkNet.Portable.Milestone.cs
// Created: 14.02.2015
...
using TeamWorkNet.Base.Handler;
...
namespace TeamWorkNet.Model
{
  public class Milestone
  {
    ...
    public async Task<bool> Delete(TeamWorkClient client)
    {
      using (var handler = new MilestoneHandler(client))
      {
        await handler.DeleteMilestone(ProjectId);
      }
      return false;
    }
  }
